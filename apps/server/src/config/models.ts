...
export const MODELS: Record<string, ModelConfig> = {
  ...
  'wanxiang-2.7-t2v': {
    ...
    parameters: [
      ...
      { name: 'duration', type: 'number', defaultValue: 5, min: 3, max: 10, description: '视频时长（秒）' },
      { name: 'watermark', type: 'boolean', defaultValue: true, description: '添加水印' },
    ],
  },
};
...
export const MODEL_CATEGORIES = [
  { id: 'text', name: '文本生成', icon: 'file-text' },
  { id: 'image', name: '图像生成', icon: 'image' },
  { id: 'video', name: '视频生成', icon: 'video' },
  { id: 'audio', name: '音频生成', icon: 'music' },
] as const;
